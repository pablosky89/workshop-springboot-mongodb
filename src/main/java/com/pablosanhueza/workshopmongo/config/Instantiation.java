...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2018"), "Partio el viaje", "Me voy para Santiago, adios", maria);
		Post post2 = new Post(null, sdf.parse("23/03/2018"), "Buenos dias", "Desperte feliz hoy", maria);
